...
func TestValidate(t *testing.T) {
	...
	validResendVerification := Config{HeroKey: "key", USDCNY: 7.2, Markup: 1, PayProvider: "sandbox", EmailVerificationRequired: true, ResendAPIKey: "re_xxxxxxxxx", ResendFrom: "onboarding@resend.dev", TurnstileSiteKey: "site", TurnstileSecret: "secret"}
	if err := validResendVerification.Validate(); err != nil {
		t.Fatal(err)
	}
	tests := []Config{
		...
		{HeroKey: "key", USDCNY: 7.2, Markup: 1, PayProvider: "sandbox", EmailVerificationRequired: true, ResendAPIKey: "re_xxxxxxxxx", ResendFrom: "onboarding@resend.dev"},
	}
