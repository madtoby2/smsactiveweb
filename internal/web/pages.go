...
var pageViews = map[string]pageView{
	...
	"/contact.html":                    {Template: "contact.tmpl", Title: "联系我们 - 云码台", Description: "联系云码台处理订单问题、商务合作和 API 接入。", Scripts: []string{"/contact.js?v=20260626b"}, Structured: template.JS(`{"@context":"https://schema.org","@type":"ContactPage","name":"联系我们 - 云码台","url":"https://yunmatai.xyz/contact.html","inLanguage":"zh-CN","isPartOf":{"@type":"WebSite","name":"云码台","url":"https://yunmatai.xyz/"}}`)},
